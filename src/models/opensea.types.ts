...
/**
 * Annotated store contract with OpenSea metadata
 */
...
/**
 * Annotated store spec with OpenSea metadata
 */
...
/**
 * Defines the possible types of store events that can take place
 */
